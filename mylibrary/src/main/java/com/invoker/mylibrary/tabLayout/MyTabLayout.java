package com.invoker.mylibrary.tabLayout;
...
import com.invoker.mylibrary.R;
import com.invoker.mylibrary.base.ScreenUtils;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by invoker on 2018-06-14
 * Description:
 */
public class MyTabLayout extends HorizontalScrollView {
    //默认字体大小
    //private final int DEFAULT_NORMAL_TEXT_SIZE_SP = ScreenUtils.sp2px(13);
    private final int DEFAULT_NORMAL_TEXT_SIZE_SP = 13;  // invoker20180611 ScreenUtils.sp2px(13) 返回的数据报错
    ...
    private final int DEFAULT_SELECT_TEXT_SIZE_SP = 30;
